...
namespace MyMood.Web.Controllers
{
    public partial class EventLogController
    {
        ...
        protected EventLogController(Dummy d) { }
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public EventLogController Actions { get { return MVC.EventLog; } }
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Area = "";
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Name = "EventLog";
        [GeneratedCode("T4MVC", "2.0")]
        public const string NameConst = "EventLog";
        ...
        public class ActionParamsClass_Index
        {
            ...
            public readonly string searchLogEarliestDate = "searchLogEarliestDate";
            public readonly string searchLogLatestDate = "searchLogLatestDate";
        }
        ...
        public class ViewsClass
        {
            ...
            {
                public readonly string EventLogIndex = "EventLogIndex";
            }
            public readonly string EventLogIndex = "~/Views/EventLog/EventLogIndex.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_EventLogController : MyMood.Web.Controllers.EventLogController
    {
        public T4MVC_EventLogController() : base(Dummy.Instance) { }
