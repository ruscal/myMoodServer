...
namespace MyMood.Web.Controllers
{
    public partial class PushNotificationController
    {
        ...
        protected PushNotificationController(Dummy d) { }
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public PushNotificationController Actions { get { return MVC.PushNotification; } }
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Area = "";
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Name = "PushNotification";
        [GeneratedCode("T4MVC", "2.0")]
        public const string NameConst = "PushNotification";
        ...
        public class ViewsClass
        {
            ...
            {
                public readonly string Edit = "Edit";
                public readonly string PushNotificationIndex = "PushNotificationIndex";
            }
            public readonly string Edit = "~/Views/PushNotification/Edit.cshtml";
            public readonly string PushNotificationIndex = "~/Views/PushNotification/PushNotificationIndex.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_PushNotificationController : MyMood.Web.Controllers.PushNotificationController
    {
        public T4MVC_PushNotificationController() : base(Dummy.Instance) { }
        ...
        partial void SaveOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, MyMood.Web.Models.EditPushNotificationModel model);

        public override System.Web.Mvc.ActionResult Save(MyMood.Web.Models.EditPushNotificationModel model)
        {
